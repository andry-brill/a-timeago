...
const LocaleConfig locale = LocaleConfig(
  locale: Locale.fromSubtags(languageCode: 'nso'),
...
const _long = TimeAgoFormatLabels(
  relative: TimeAgoRelativeLabels(
    ...
    day: TimeAgoRelativeUnitLabels.same(
        current: 'lehono', past: '-{0} d', future: '+{0} d'),
    week: TimeAgoRelativeUnitLabels.same(
        current: 'beke ye', past: '-{0} w', future: '+{0} w'),
    month: TimeAgoRelativeUnitLabels.same(
        current: 'kgwedi ye', past: '-{0} m', future: '+{0} m'),
    quarter: TimeAgoRelativeUnitLabels.same(
        current: 'this quarter', past: '-{0} Q', future: '+{0} Q'),
    year: TimeAgoRelativeUnitLabels.same(
        current: 'ngwaga wo', past: '-{0} y', future: '+{0} y'),
  ),
