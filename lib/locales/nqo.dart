...
const LocaleConfig locale = LocaleConfig(
  locale: Locale.fromSubtags(languageCode: 'nqo'),
...
const _long = TimeAgoFormatLabels(
  relative: TimeAgoRelativeLabels(
    ...
    day: TimeAgoRelativeUnitLabels.same(
        current: 'ߓߌ߬', past: '-{0} d', future: '+{0} d'),
    week: TimeAgoRelativeUnitLabels.same(
        current: 'ߟߐ߯ߕߍ ߣߌ߲߬', past: '-{0} w', future: '+{0} w'),
    month: TimeAgoRelativeUnitLabels.same(
        current: 'ߞߊߙߏ ߣߌ߲߬', past: '-{0} m', future: '+{0} m'),
    quarter: TimeAgoRelativeUnitLabels.same(
        current: 'this quarter', past: '-{0} Q', future: '+{0} Q'),
    year: TimeAgoRelativeUnitLabels.same(
        current: 'ߢߌ߬ߣߊ߲߬', past: '-{0} y', future: '+{0} y'),
  ),
...
const _narrow = TimeAgoFormatLabels(
  relative: TimeAgoRelativeLabels(
    ...
    hour: TimeAgoRelativeUnitLabels.same(
        current: 'this hour', past: '-{0} h', future: '+{0} h'),
    day: TimeAgoRelativeUnitLabels.same(
        current: 'ߓߌ߬', past: 'ߊ߬ ߟߐ߯ߕߍ߫ {0} ߟߋ߫ ߣߌ߲߬', future: '+{0} d'),
    week: TimeAgoRelativeUnitLabels.same(
        current: 'ߟߐ߯ߕߍ ߣߌ߲߬', past: '-{0} w', future: '+{0} w'),
    month: TimeAgoRelativeUnitLabels.same(
        current: 'ߞߊߙߏ ߣߌ߲߬', past: '-{0} m', future: '+{0} m'),
  ...
  units: TimeAgoUnitLabels(
    ...
    minute: TimeAgoPluralLabels.same('{0} min'),
    hour: TimeAgoPluralLabels.same('{0} h'),
    day: TimeAgoPluralLabels.same('ߊ߬ ߟߐ߯ߕߍ߫ {0} ߟߋ߫ ߣߌ߲߬'),
    week: TimeAgoPluralLabels.same('{0} w'),
    month: TimeAgoPluralLabels.same('{0} m'),
    quarter: TimeAgoPluralLabels.same('{0} Q'),
    year: TimeAgoPluralLabels.same('{0} y'),
